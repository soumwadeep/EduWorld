...
<html lang="en">
  ...
  <body>
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li>
              <a href="#"><span class="fa fa-pencil-square"></span> Homework</a>
          </li>
          <li>
          ...
          <li class="active">
            <a href="#"><span class="fa fa-comment"></span> Contact</a>
          </li>
          <li>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <p style="color: black;"><b>This Is Your Contact Section.From Here You Can Directly Contact To Your Mentor Or Teacher For Clearing Any Doubts.</b></p>
        <p><b>Ask Your Question In This Form:</b></p>
        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeggN2xAHfy5hlYjirJymZDrjN5_4i7eknaxvZDNjIuQ0cURQ/viewform?usp=sf_link/viewform?embedded=true" style="width:100%; height:600px; border:0;">Loading…</iframe>
      </div>
		</div>
